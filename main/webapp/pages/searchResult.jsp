...
<form:c id = "search" action="http://localhost:9100/application/searchBook?search=${search}" method="get" >
    <table>
     <tr>
       <td>
	...
	<div id="wrapper">
		...
		<%-- <h2>Reviews on <b>${book.bookName}</b> by <b> ${book.author}</b></h2> --%>
					...
					<tbody>
						<c:forEach items="${book}" var="book">
							<tr>
								...
								<td>2</td>
								<td><a
									href="http://localhost:9100/application/reviews/viewReview?bookId=${book.bookId}">See
										Review</a>
							</tr>
						</c:forEach>
					</tbody>
